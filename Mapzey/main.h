...
struct {
	...
	bool WEAPON = false;
	bool skeleton = true;
	bool vehicless = false;
	bool FPAimbot = false;
	bool playergay = false;
	bool tpos = false;
	bool lottesssppp = false;
	...
	float RadarPosX = 120.f;
	float RadarPosY = 120.f;


	float RenderDistance = 120.f;
	float LineDistance = 120.f;
	...
	float SkeletonESPS[3] = { color.Black[0], color.Black[1], color.Black[2] };
	...
	ImColor BoxColorNotVisible = 0;
	ImColor BoxColorVisible = 0;

	ImColor SkeletonColor = 0;

	ImColor LineColor = 0;

	ImColor DistanceColor = 0;
